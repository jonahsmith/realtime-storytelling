...
while True:
    ...
    # This code runs when the 'anomaly' key is False, which happens at the end
    # of anomalous periods.
        ...
        # We can estimate the duration of the anomalous period by subtracting
        # the timestamp on this message from the timestamp on the beginning of
        # the anomalous period, captured by `begin`
